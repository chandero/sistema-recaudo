#!/usr/bin/env python3
"""
Script simplificado para limpiar los campos de resolución de todas las obligaciones en la base de datos.
Campos a limpiar:
...
if __name__ == "__main__":
    logger.info("Ejecutando script de limpieza simplificado...")
